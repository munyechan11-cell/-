    ...
    if (isLogin) {
      ...
      if (cleanPhone && name) {
        ...
        if (existingUser) {
          ...
          // Do not automatically switch to login tab to let user see the error clearly
        } else {
    ...
    <div className="min-h-full bg-transparent flex flex-col items-center justify-center p-4">
      <div className="max-w-md w-full bg-white/90 backdrop-blur-sm rounded-3xl shadow-[0_4px_20px_rgba(78,52,46,0.08)] border border-[#E7E0D7] overflow-hidden relative">
        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-6">
          ...
          <button 
            type="submit"
            className="w-full bg-[#D84315] hover:bg-[#BF360C] text-white font-bold py-4 rounded-xl transition-colors text-lg"
          >
