        ...
        <div className="bg-white p-10 rounded-[3rem] shadow-3xl border border-[#e5dcd3] space-y-8 relative overflow-hidden">
           ...
           <div className="pt-4 space-y-6">
              ...
              <div className="grid grid-cols-3 gap-3">
                 <button onClick={() => handleOAuthLogin('google')} className="p-4 bg-white rounded-xl border border-[#e5dcd3] flex items-center justify-center hover:shadow-md transition-all">
                 ...
                 <button onClick={() => handleOAuthLogin('kakao')} className="col-span-2 py-4 bg-[#FEE500] rounded-xl flex items-center justify-center gap-3 hover:shadow-md transition-all">
