            ...
            <div className="animate-in fade-in slide-in-from-top-2">
              ...
              <div className="flex space-x-2">
                <input 
                  ...
                  className="flex-1 px-4 py-3 rounded-xl border-2 border-[#E7E0D7] focus:border-[#4E342E] focus:ring-0 transition-colors"
                  maxLength={6}
                />
                <button
                  type="button"
                  ...
                  className="px-6 py-3 bg-[#4E342E] hover:bg-[#3E2723] disabled:bg-[#4E342E]/50 text-white rounded-xl font-bold whitespace-nowrap transition-colors"
                >
                  확인
                </button>
              </div>
